...
var banamaFile = 'country_banama.json';
...
// 			specular: 	0x333333,
	...
	console.time('loadBanamaData');
	loadBanamaData( banamaData );				
	console.timeEnd('loadBanamaData');		
    ...
    selectVisualization( timeBins, '2010', ['TAIWAN']);					
