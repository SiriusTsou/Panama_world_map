...
function attachMarkerToCountry( countryName, importance ){
	...
	if (banamabigData[countryName] != undefined)
     importExportText += "Companies:&nbsp;" +banamabigData[countryName].companies+ "<br />" +
	                     "Intermediary:&nbsp;"+banamabigData[countryName].intermediary+ "<br />"+ "Officer:&nbsp;"+banamabigData[countryName].officer;
